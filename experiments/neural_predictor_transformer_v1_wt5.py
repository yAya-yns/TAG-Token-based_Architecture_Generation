...
#sys.path.append('C:\\Users\\qiang\\Documents\\Programs\\CSC413\\TAG')
...
class DeepNets1M_dataset(Dataset):
    ...
    def get_data_from_graphbatch(self, graphs):
        ...
        for graph in graphs:  # graphbatch has size 1 for eval
            ...
            i = 0
            fnodes = np.zeros((self.max_nodes, 1))
            ...
            mask = mask[0]
            data.append([num_vertices, adjacency, operations, mask, fnodes])
    ...
    def __getitem__(self, index):
        ...
        num_vertices, adjacency, operations, mask, fnodes = self.get_data_from_graphbatch(graphs)
...
def main():
    ...
    net = NeuralPredictor(initial_hidden=11,dim_hidden=args.gcn_hidden)
    net.cuda()
